...
<template>
  ...
  <div class="container mx-auto">
    ...
    >
      <div class="flex flex-col justify-start gap-[24px] py-[16px]">
        ...
        <Button
          buttonType="primary"
          extraClass="text-[18px] font-[600] w-[139px] h-[59px]"
          >اتعلم من هنا</Button
        >
      </div>
      <div class="order-[-1] lg:order-1">
        <img
          class="rounded-lg"
          src="../../assets/newSkillsLearning.png"
          alt="Learning"
        />
      </div>
    </div>
  ...
  <div class="container mx-auto">
    ...
    >
      ...
      <div class="flex flex-col justify-start gap-[24px] py-[16px]">
        ...
        <Button
          @clickButton="() => router.push('/signup')"
          buttonType="primary"
          extraClass="text-[18px] font-[600] w-[139px] h-[59px]"
          >سجل معنا</Button
        >
  ...
  <div
    class="flex flex-col gap-[24px] bg-[#F2F7FF] py-[32px] lg:py-[48px] lg:pb-[128px] "
  >
  <h1 class="text-[32px] text-black text-center font-[600]">
    أسئلة <span class="text-[#246BFD]">شائعة</span>
  </h1>
  <div class="container mx-auto">
      <Accordion class="mb-[24px]" v-for="faq in faqsArray" :title="faq.title" :open="faq.open">
        {{ faq.description }}
      </Accordion>
    </div>
  </div>
