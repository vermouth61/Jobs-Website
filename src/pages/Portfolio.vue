...
<template>
    <div dir="rtl" class="w-full flex flex-col items-center bg-[#F6F8FA] border-[1px] border-[#B8BCC7] p-[24px] rounded-lg gap-[40px]">
        ...
        <div class="flex flex-wrap justify-center md:justify-start lg:justify-center xl:justify-start gap-[20px]">
           <PortfolioCard v-for="workerPortfolio in portfolioArray" :workerPortfolio="workerPortfolio" />
        </div>
